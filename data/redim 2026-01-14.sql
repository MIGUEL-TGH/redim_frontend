...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-01-2026 a las 14:56:50
...
INSERT INTO `indicator_category_details` (`id`, `indicator_category_id`, `year_id`, `gender_id`, `center_id`, `state_id`, `quantity`, `status`) VALUES
(1, 1, 15, 2, 1, 1, '0', 1),
(2, 1, 15, 1, 1, 1, '0', 1),
(3, 1, 16, 2, 1, 1, '0', 1),
(4, 1, 16, 1, 1, 1, '0', 1),
