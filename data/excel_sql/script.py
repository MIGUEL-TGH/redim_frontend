...
data = pd.read_excel("1.-cnsipee_ejer_func.xlsx")
# years = pd.read_excel("2.-tables_db.xlsx", sheet_name="YEARS")
years = pd.read_excel("2.-tables_db.xlsx", sheet_name="YEARS")[["id","name"]]
states = pd.read_excel("2.-tables_db.xlsx", sheet_name="ESTADOS")[["id","name"]]
genders = pd.read_excel("2.-tables_db.xlsx", sheet_name="GENDERS")[["id","name"]]
categories = pd.read_excel("2.-tables_db.xlsx", sheet_name="CATEGORIES")[["id","name"]]
