...
<style scoped>
  ...
  .hero-inner {
    ...
    max-width: 800px;
    margin: 0 auto;
    /* Alto suficiente para contener la imagen de manos completa (≈437px de alto) */
    min-height: 440px;
  }
  ...
  .hero-hands {
    position: absolute;
    right: -10px;
    /* La base de la imagen coincide con el inicio de la zona naranja, sin recorte */
    bottom: 0;
    /* 20% más grande que el tamaño anterior (540px → 648px) */
    width: 648px;
    max-width: 82%;
    height: auto;
    z-index: 1;
  ...
  /* Encabezado: muñeco (izq) + título (der) en la misma línea */
  .podcast-head {
    position: relative;
    z-index: 1;
    display: flex;
  ...
  /* Muñeco azul: queda detrás de los cards; solo se ocultan sus pies (30% inferior) */
  .podcast-character {
    width: 210px;
    max-width: 38vw;
    height: auto;
  ...
  /* El escenario del carrusel sube (z-index mayor) para cubrir los pies del muñeco */
  .podcast-stage {
    position: relative;
    z-index: 2;
    max-width: 1000px;
