...
<style scoped>
  ...
  /* Estado: VISIBLE (Blanco, redondo) */
  .btn-open {
    background-color: white !important;
    color: #276acc !important;
    border: 2px solid white !important;
  }

  /* ===============================
    1 y 2. PANEL DESPLEGABLE (Morado, borde inf-der)
  ================================ */
  .dropdown-panel {
    position: fixed;
    top: 64px;
  ...
  /* Laptops y Escritorio (mayor a 960px) */
